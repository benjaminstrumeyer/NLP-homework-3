"use strict";
class Analyzer {
    static computeConfusionMatrix(originalPairs, predictedPairs) {
    ...
    static generateMatrix(matrixMap, topTags) {
        ...
        return { matrix: matrix, tags: tags };
    }
    static getTopTags(matrixMap, count) {
        var tagsArray = [];
    ...
    static getConfusionMatrixMap(originalPairs, predictedPairs) {
        var matrixMap = {};
